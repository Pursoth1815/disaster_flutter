import 'package:disapp/bankform%20copy.dart';
...
class _BasicFormState extends State<BasicForm> {
  ...
  Future<String> getSelectData() async {
    // Starting Web API Call.
    // final String url = "http://localhost:3002/get_select_data";
    // final String url = "http://192.168.43.230:3002/get_select_data";
    final String url = "http://192.168.1.7:3002/get_select_data";
  ...
  void postconnection() async {
    var connection = PostgreSQLConnection("127.0.0.1", 5432, "disaster",
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: DropdownButton(
                    ...
                    onChanged: (value) {
                      ...
                      newBasic.ben_dist_code = value;
                      AppID1 = newBasic.ben_dist_code;
                      print(value);
                    },
                  ...
                  child: DropdownButton(
                    ...
                    onChanged: (value) {
                      setState(() {
                        ...
                        selectedVillage = null;
                        lstVillage.clear();
                        this.getVillage(selectedDistrict, selectedTaluk);
                      });
                      newBasic.ben_tlk_code = value;
                      AppID2 = newBasic.ben_tlk_code;
                      print(value);
                    },
                    value: selectedTaluk,
                ...
                Padding(
                  ...
                  child: DropdownButton(
                    ...
                    onChanged: (value) {
                      ...
                      newBasic.ben_vill_code = value;
                      AppID3 = newBasic.ben_vill_code;
                    },
                ...
                //       child: TextFormField(
                //         onSaved: (val) {
                //           newBasic.ben_dopapp= formatter.format(selectedben_doapp);
                //         },
                //         controller: _ben_doappController,
                //         decoration: InputDecoration(
                //           labelText: "Date of Application",
...
//Snackbar Message
  ...
  void _submitForm() async {
    ...
    if (!form.validate()) {
      ...
      AppID = selectedState + AppID1 + AppID2 + AppID3 + AppYear + AppCounter;
      newBasic.ben_app_id = AppID;
      ...
      print('District: ${newBasic.ben_dist_code}');
      print('Taluk: ${newBasic.ben_tlk_code}');
      print('Village: ${newBasic.ben_vill_code}');
      print('Gender: ${newBasic.ben_gen_code}');
      print('Community: ${newBasic.ben_com_code}');
      ...
      final response = await basicService.createBasic(newBasic);

      print(response);

      if (response == 'success') {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => BankForm()));
      } else {
